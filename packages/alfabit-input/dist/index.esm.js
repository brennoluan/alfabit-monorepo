...
var InputContainer = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  width: 100%;\n  background: #f8f8f8;\n  border-radius: 8px;\n  display: flex;\n  flex-direction: column;\n  padding: ", ";\n  border: 1px solid transparent;\n\n  ", "\n\n  &:hover {\n    border: 1px #1b4af0 solid;\n  }\n"], ["\n  width: 100%;\n  background: #f8f8f8;\n  border-radius: 8px;\n  display: flex;\n  flex-direction: column;\n  padding: ", ";\n  border: 1px solid transparent;\n\n  ", "\n\n  &:hover {\n    border: 1px #1b4af0 solid;\n  }\n"])), function (_a) {
    ...
    return isFocused && css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      border: 1px #1b4af0 solid;\n    "], ["\n      border: 1px #1b4af0 solid;\n    "])));
});
...
var Input = function (_a) {
    ...
    return (React.createElement(InputContainer, { hasLabel: !!label, isFocused: isFocused },
        label && React.createElement(Label, null, label),
        React.createElement(StyledInput, __assign({ disabled: disabled, placeholder: placeholder }, props, { onFocus: function () { return setIsFocused(true); }, onBlur: function () { return setIsFocused(false); } }))));
};
